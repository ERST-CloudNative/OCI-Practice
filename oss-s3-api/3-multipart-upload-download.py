...
# upload_with_high_threshold('C://Users//loren//PycharmProjects//pythonProject//test.zip', 'my-bucket', 'test.zip', 8)

# Test 2


# upload_with_default_configuration(
#     'C://Users//loren//PycharmProjects//pythonProject//test.zip',
#     'my-bucket',
#     'test.zip',
#     24
# )
...
upload_with_sse('C://Users//loren//PycharmProjects//pythonProject//test.zip', 'my-bucket', 'test.zip', 1, secret_key)
print('\n------------------\n')
download_with_sse(
    'my-bucket',
    'test.zip',
    'C://Users//loren//PycharmProjects//pythonProject//test5.zip',
    8,
    secret_key
)
